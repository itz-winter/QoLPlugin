...
public class TpaCommand implements CommandExecutor, TabCompleter {
    ...
    public TpaCommand(KelpylandiaPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        // Send the request
        TpaRequest request = tpaManager.sendRequest(player, target, TpaRequest.Type.TPA);
        if (request == null) {
        ...
        player.sendMessage(ChatColor.GRAY + "The request will expire in " + request.getSecondsRemaining() + " seconds.");
        ...
        target.sendMessage(ChatColor.GREEN + " " + player.getName() + ChatColor.YELLOW + " has requested to teleport to you.");
        ...
        accept.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,
            new ComponentBuilder("Click to accept the teleport request").color(net.md_5.bungee.api.ChatColor.GREEN).create()));
