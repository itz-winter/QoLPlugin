...
package com.kelpwing.kelpylandiaplugin.chat.utils;
...
public class ChatColorUtils {
    ...
    public static String filterIllegalColorCodes(String string) {
        return filterIllegalColorCodes(string, false);
    }
    ...
    public static String translateAlternateColorCodes(char code, String text) {
        return translateAlternateColorCodes(code, text, false, true, Collections.emptyList());
    }
